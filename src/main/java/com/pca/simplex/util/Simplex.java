...
public final class Simplex {
	...
	private static final BigDecimal UM_NEGATIVO = new BigDecimal("-1");
	private static BigDecimal[][] tabelaSubCelulaSuperior;
	private static BigDecimal[][] tabelaSubCelulaInferior;

	public static void  calcularSimplex(DadoFuncaoObjetivo dadoFuncaoObjetiva) throws Exception{
	 ...
	 */
	private static void alterarTipoFuncaoObjetiva(DadoFuncaoObjetivo dadoFuncaoObjetiva) {
	 ...
	 * @param dadoFuncaoObjetiva
	 */
	private static void adicionaVariaveisAuxiliares(DadoFuncaoObjetivo dadoFuncaoObjetiva) {
	 ...
	 * @return {@link Integer}
	 */
	private static Integer obterProximoNumeroVariavel(List<ValorSentenca> listaSentencasFuncaoObjetiva) {
	 ...
	 */
	private static void preencheFuncaoObjetivaTabelaSimplex(DadoFuncaoObjetivo dadoFuncaoObjetiva) {
	 ...
	 * @param tabelaSubCelulaSuperior
	 */
	private static void preencheRestricoesTabelaSimplex(DadoFuncaoObjetivo dadoFuncaoObjetiva) {
		int linha = 1;
	...
	private static void printarRestricoes(DadoFuncaoObjetivo dadoFuncaoObjetiva) {
		for (DadoRestricao dadoRestricao : dadoFuncaoObjetiva.getListaDadosRestricoes()) {
	 ...
	 * @throws Exception 
	 */
	private static void procurarVariavelBasicaMembroLivreNegativo() throws Exception {
		//1ª Fase, passo 1
	 ...
	 * @throws Exception 
	 */
	private static void procurarElementoNegativoNaLinha(int indiceLinhaPossuiMembroLivreNegativo) throws Exception {
		...
		if(elementoPermitido == null && indiceColunaPermitida == null){
			//TODO LANÇAR EXCEÇÃO DE SOLUÇÃO PERMISSÍVEL NÃO EXISTENTE
		}else{
	 ...
	 * @throws Exception 
	 */
	private static void procurarLinhaPermitida(Integer indiceColunaPermitida) throws Exception {
	...
	private static String verificarSinalElemento(BigDecimal elementoPermitido) {
	...
	private static void executarAlgoritmoTroca(Integer indiceLinhaPermitida, Integer indiceColunaPermitida) throws Exception {
	...
	private static BigDecimal calculaInversoElementoPermitido(Integer indiceLinhaPermitida, Integer indiceColunaPermitida) {
	 ...
	 * @param indiceColunaPermitida 
	 */
	private static void multiplicarLinhaPermitidaPorElementoPermitidoInvertido(BigDecimal elementoPermitidoInvertido,
	 ...
	 * @param indiceColunaPermitida 
	 */
	private static void multiplicarColunaPermitidaPorElementoPermitidoInvertido(BigDecimal elementoPermitidoInvertido,
			Integer indiceLinhaPermitida, Integer indiceColunaPermitida) {
	 ...
	 * @param indiceColunaPermitida
	 */
	private static void preencherTodasCelulasTabelaSubCelulaInferiorVazias(Integer indiceLinhaPermitida,
	...
	private static void inverterLinhaPermitidaComColunaPermitida(Integer indiceLinhaPermitida,
			Integer indiceColunaPermitida) {
	 ...
	 * 
	 */
	private static void executaSegundaFaseAlgoritmoSimplex() throws Exception {
	 ...
	 * @throws Exception 
	 */
	private static void procurarElementoPositivoLinhaFuncaoObjetivo() throws Exception {
	 ...
	 * @throws Exception 
	 */
	private static void procuraElementoPositivoColunaPermitida(int indiceColuna) throws Exception {
		 for (int i = 1; i < tabelaSubCelulaSuperior.length; i++) {
			if(tabelaSubCelulaSuperior[i][indiceColuna].compareTo(BigDecimal.ZERO) == 1){
				procurarLinhaPermitida(indiceColuna);
			}
		}
		 //TODO SOLUÇÃO ÓTIMA ILIMITADA
	}
